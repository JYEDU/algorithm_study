...
#### [신고 결과 받기](https://github.com/JYEDU/algorithm_study/blob/main/programmers/receive_report.py)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/92334)
- python

#### [푸드 파이트 대회](https://github.com/JYEDU/algorithm_study/blob/main/programmers/food_fighter_competition.py) 
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/134240)
- python

#### [햄버거 만들기](https://github.com/JYEDU/algorithm_study/blob/main/programmers/make_hamburger.py)
...
#### [추억 점수](https://github.com/JYEDU/algorithm_study/blob/main/programmers/memory_score.py)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/176963)
- python


## WEEK 3
#### [덧칠하기](https://github.com/JYEDU/algorithm_study/blob/main/programmers/overcoat.py)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/161989)
- python

#### [하샤드 수 구하기](https://github.com/JYEDU/algorithm_study/blob/main/programmers/harshad_number.py)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/12947#)
- python

#### [바탕화면 정리](https://github.com/JYEDU/algorithm_study/blob/main/programmers/clean_files.py)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/161990)
- python

#### [기사단원의 무기](https://github.com/JYEDU/algorithm_study/blob/main/programmers/weapon_power.py)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/136798)
- python

#### [둘만의 암호](https://github.com/JYEDU/algorithm_study/blob/main/programmers/two_person_code.py)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/155652)
- python

#### [가장 가까운 같은 글자](https://github.com/JYEDU/algorithm_study/blob/main/programmers/near_same_word.py)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/142086)
- python

#### [완주하지 못한 선수](https://github.com/JYEDU/algorithm_study/blob/main/programmers/non_complete_runner.py)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/42576)
- python

#### [의상](https://github.com/JYEDU/algorithm_study/blob/main/programmers/clothes.py)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/42578)
- python


## WEEK 2
#### [징검다리](https://github.com/JYEDU/algorithm_study/blob/main/programmers/stepping_stones.py)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/43236)
- python

#### [입국심사](https://github.com/JYEDU/algorithm_study/blob/main/programmers/immigration_interview.py)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/43238)
- python

#### [stock prices](https://github.com/JYEDU/algorithm_study/blob/main/testdome/stock_prices.py)
- [testdome](https://www.testdome.com/questions/python-data-science/stock-prices/84848)
- python, numpy, pandas

#### [Login Table](https://github.com/JYEDU/algorithm_study/blob/main/testdome/login_table.py)
- [testdome](https://www.testdome.com/questions/python-data-science/login-table/81252)
- python, pandas

#### [Marketing Costs](https://github.com/JYEDU/algorithm_study/blob/main/testdome/marketing_costs.py)
...
#### [Iris Classifier](https://github.com/JYEDU/algorithm_study/blob/main/testdome/iris_classifier.py)
...
## WEEK 1
#### [폰켓몬](https://github.com/JYEDU/algorithm_study/blob/main/programmers/phonekemon.py)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/1845?language=python3)
- python

#### [전화번호 목록](https://github.com/JYEDU/algorithm_study/blob/main/programmers/phone_book_list.py)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/42577)
- python 

#### [베스트앨범](https://github.com/JYEDU/algorithm_study/blob/main/programmers/best_album.py)
...
#### [정수삼각형](https://github.com/JYEDU/algorithm_study/blob/main/programmers/int_triangle.py)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/43105)
- python

#### [신규 아이디 추천](https://github.com/JYEDU/algorithm_study/blob/main/programmers/id_recommend.py)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/72410#)
- python

#### [메뉴 리뉴얼](https://github.com/JYEDU/algorithm_study/blob/main/programmers/menu_renewal.py)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/72411)
- python

#### [Malware Analysis](https://github.com/JYEDU/algorithm_study/blob/main/testdome/Malware_Analysis.py)
- [testdome](https://www.testdome.com/questions/python/malware-analysis/108074)
- python

#### [주문량이 많은 아이스크림들 조회하기](https://github.com/JYEDU/algorithm_study/blob/main/etc/sql-join.sql)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/133027)
- sql, join

#### [없어진 기록 찾기](https://github.com/JYEDU/algorithm_study/blob/main/etc/sql-join.sql)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/59042)
- sql, join

#### [평균 일일 대여 요금 구하기](https://github.com/JYEDU/algorithm_study/blob/main/etc/sql-select.sql)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/151136)
- SQL, select

#### [재구매가 일어난 상품과 회원 리스트 구하기](https://github.com/JYEDU/algorithm_study/blob/main/etc/sql-select.sql)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/131536)
- SQL, select

#### [오프라인/온라인 판매 데이터 통합하기](https://github.com/JYEDU/algorithm_study/blob/main/etc/sql-select.sql)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/131537)
- SQL, select

#### [아픈 동물 찾기](https://github.com/JYEDU/algorithm_study/blob/main/etc/sql-select.sql)
- [programmers](https://school.programmers.co.kr/learn/courses/30/lessons/59036)
- SQL, select

#### [젊은 동물 찾기](https://github.com/JYEDU/algorithm_study/blob/main/etc/sql-select.sql)
